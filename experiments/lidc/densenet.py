...
class FCNDenseNet(nn.Module):
    def __init__(self, pretrained, num_classes, backbone='densenet121'):
        ...
        self.conv1 = nn.Conv2d(1024+256, 256, kernel_size=1, stride=1,
                            padding=0, bias=False)
        self.conv2 = nn.Conv2d(256+64, 64, kernel_size=1, stride=1,
                            padding=0, bias=False)
    ...
    def forward(self, x):
        ...
        features_cat2 = torch.cat([features2, F.interpolate(features_cat1, scale_factor=4)], dim=1)
